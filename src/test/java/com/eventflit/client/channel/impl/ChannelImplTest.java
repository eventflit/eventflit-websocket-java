...
public class ChannelImplTest {
    ...
    public void testReturnsCorrectUnsubscribeMessage() {
        assertEquals("{\"event\":\"eventflit:unsubscribe\",\"data\":{\"channel\":\"" + getChannelName() + "\"}}",
    ...
    public void testInternalSubscriptionSucceededMessageIsTranslatedToASubscriptionSuccessfulCallback() {
        ...
        channel.onMessage("eventflit_internal:subscription_succeeded",
                "{\"event\":\"eventflit_internal:subscription_succeeded\",\"data\":\"{}\",\"channel\":\""
                        + getChannelName() + "\"}");
    ...
    public void testBindToInternalEventThrowsException() {
        channel.bind("eventflit_internal:subscription_succeeded", mockListener);
    }
