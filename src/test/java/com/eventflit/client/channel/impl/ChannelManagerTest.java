...
public class ChannelManagerTest {
    ...
    private static final String OUTGOING_SUBSCRIBE_MESSAGE = "{\"event\":\"eventflit:subscribe\"}";
    private static final String OUTGOING_UNSUBSCRIBE_MESSAGE = "{\"event\":\"eventflit:unsubscribe\"}";
    private static final String SOCKET_ID = "21234.41243";
    private static final String PRIVATE_OUTGOING_SUBSCRIBE_MESSAGE = "{\"event\":\"eventflit:subscribe\", \"data\":{}}";
