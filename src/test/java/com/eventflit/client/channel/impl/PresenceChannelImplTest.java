...
public class PresenceChannelImplTest extends PrivateChannelImplTest {
    ...
    public void testReturnsCorrectSubscribeMessage() {
        ...
        assertEquals("{\"event\":\"eventflit:subscribe\",\"data\":{\"channel\":\"" + getChannelName() + "\","
    ...
    public void testIsSubscribedMethod(){
        ...
        channel.onMessage("eventflit_internal:subscription_succeeded",
                "{\"event\":\"eventflit_internal:subscription_succeeded\",\"data\":\"{\\\"presence\\\":{\\\"count\\\":1,\\\"ids\\\":[\\\"5116a4519575b\\\"],\\\"hash\\\":{\\\"5116a4519575b\\\":{\\\"name\\\":\\\"Phil Leggetter\\\",\\\"twitter_id\\\":\\\"@leggetter\\\"}}}}\",\"channel\":\"presence-myChannel\"}");
    ...
    public void testInternalSubscriptionSucceededMessageIsTranslatedToASubscriptionSuccessfulCallback() {
        ...
        final String eventName = "eventflit_internal:subscription_succeeded";
    ...
    public void testThatUserIdsPassedAsIntegersGetStoredAsStringifiedIntegersAndNotDoubles() {
        ...
        final String eventName = "eventflit_internal:member_added";
    ...
    public void testInternalMemberRemovedMessageIsTranslatedToUserUnsubscribedCallback() {
        ...
        final String eventName = "eventflit_internal:member_removed";
