 ...
 * </p>
 * <ul>
 * <li>Call {@link com.eventflit.client.Eventflit#subscribe(String)} to subscribe and
...
public interface ChannelEventListener extends SubscriptionEventListener {
     ...
     * message is received from Eventflit after subscribing to the channel.
     * </p>
     *
     * <p>
     * For public channels this callback will be more or less immediate,
     * assuming that you are connected to Eventflit at the time of subscription.
