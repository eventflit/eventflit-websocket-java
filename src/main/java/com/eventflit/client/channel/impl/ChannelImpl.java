...
public class ChannelImpl implements InternalChannel {
    ...
    private static final String INTERNAL_EVENT_PREFIX = "eventflit_internal:";
    protected static final String SUBSCRIPTION_SUCCESS_EVENT = "eventflit_internal:subscription_succeeded";
    ...
    public String toSubscribeMessage() {
        ...
        jsonObject.put("event", "eventflit:subscribe");
    ...
    public String toUnsubscribeMessage() {
        final Map<Object, Object> jsonObject = new LinkedHashMap<Object, Object>();
        jsonObject.put("event", "eventflit:unsubscribe");
    ...
    private void validateArguments(final String eventName, final SubscriptionEventListener listener) {
        ...
        if (state == ChannelState.UNSUBSCRIBED) {
            throw new IllegalStateException(
                    "Cannot bind or unbind to events on a channel that has been unsubscribed. Call Eventflit.subscribe() to resubscribe to this channel");
        }
    }
}
