 ...
 * connection itself can be retrieved from the {@link com.eventflit.client.Eventflit}
 * object by calling {@link com.eventflit.client.Eventflit#getConnection()}.
 * </p>
 *
 * <p>
 * Alternatively, you can bind your implementation of the interface and connect
 * at the same time by calling
 * {@link com.eventflit.client.Eventflit#connect(ConnectionEventListener, ConnectionState...)}
 * .
 * </p>
 */
public interface ConnectionEventListener {
     ...
     * to Eventflit and during disconnection and reconnection.
     *
     * <p>
     ...
     * <ul>
     * <li>An error message has been received from Eventflit, or</li>
