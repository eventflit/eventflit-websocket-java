...
/**
 * Configuration for a {@link com.eventflit.client.Eventflit} instance.
 */
public class EventflitOptions {
    ...
    private static final String EVENTFLIT_DOMAIN = "eventflit.com";
    ...
    // (others are subdomains of eventflit.com). This is not an oversight.
    // Legacy reasons.
     ...
     */
    public EventflitOptions setEncrypted(final boolean encrypted) {
     ...
     * @return this, for chaining
     */
    public EventflitOptions setAuthorizer(final Authorizer authorizer) {
     ...
     *
     * Note that if you wish to connect to a standard Eventflit cluster, the
     ...
     * @return this, for chaining
     */
    public EventflitOptions setHost(final String host) {
        this.host = host;
        return this;
    }
     ...
     * @return this, for chaining
     */
    public EventflitOptions setWsPort(final int wsPort) {
        this.wsPort = wsPort;
        return this;
    }
     ...
     * @return this, for chaining
     */
    public EventflitOptions setWssPort(final int wssPort) {
        this.wssPort = wssPort;
        return this;
    }

    public EventflitOptions setCluster(final String cluster) {
        host = "ws-" + cluster + "." + EVENTFLIT_DOMAIN;
        wsPort = WS_PORT;
        wssPort = WSS_PORT;
        return this;
    }
     ...
     * intermediate hops between the application and Eventflit are aggressively
     ...
     * @return this, for chaining
     */
    public EventflitOptions setActivityTimeout(final long activityTimeout) {
     ...
     * @return this, for chaining
     */
    public EventflitOptions setPongTimeout(final long pongTimeout) {
        if (pongTimeout < 1000) {
            throw new IllegalArgumentException(
     ...
     * @return this, for chaining
     */
    public EventflitOptions setMaxReconnectionAttempts(int maxReconnectionAttempts) {
	 ...
	 * @return this, for chaining
	 */
	public EventflitOptions setMaxReconnectGapInSeconds(int maxReconnectGapInSeconds) {
     ...
     * @return this, for chaining
     */
    public EventflitOptions setProxy(Proxy proxy){
        if (proxy == null) {
    ...
    /**
     * @return The proxy to be used when opening a websocket connection to Eventflit.
     */
	...
	private static String readVersionFromProperties() {
        ...
        try {
            ...
            inStream = EventflitOptions.class.getResourceAsStream("/eventflit.properties");
            p.load(inStream);
            String version = (String)p.get("version");

            // If the properties file contents indicates the version is being run
            // from source then replace with a dev indicator. Otherwise the Eventflit
