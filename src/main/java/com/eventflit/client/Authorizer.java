...
/**
 * Subscriptions to {@link com.eventflit.client.channel.PrivateChannel Private} and
 * {@link com.eventflit.client.channel.PresenceChannel presence} channels need to
 * be authorized. This interface provides an {@link #authorize} as a mechanism
 * for doing this.
 *
 * <p>
 * See the {@link com.eventflit.client.util.HttpAuthorizer HttpAuthorizer} as an
 * example.
 * </p>
 */
